...
{
    [HttpGet("FindOne")]
    public ActionResult<Track> GetOne(string userRole, string userName, string name = "", string date = "", string location = "", string theme = "")
    {
    ...
    [HttpGet("FindMany")]
    public ActionResult<IEnumerable<Track>> GetMany(string userRole, string userName)
    {
    ...
    {
        track.UserClaims = userName;
        track.RoleClaims = userRole;
